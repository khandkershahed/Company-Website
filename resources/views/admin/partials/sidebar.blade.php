            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu {{ Route::current()->getName() == '' ? 'active' : '' }}">
                    ...
                    <ul class="nav-group-sub collapse ms-4" style="">
                        <li class="nav-item"><a href="{{ route('admin.business.index') }}"
                        ...
                        <li class="nav-item"><a href="{{ route('project.dashboard') }}" class="nav-link">Projects</a>
                        </li>
                    </ul>
                ...
                <li
                    class="nav-item nav-item-submenu {{ in_array(Route::current()->getName(), ['admin.solution-cms.index', 'solution.create']) ? ' nav-item-open' : '' }}">
                    <a href=""
                        class="nav-link {{ in_array(Route::current()->getName(), ['admin.solution-cms.index', 'solution.create']) ? ' active' : '' }}">
                        <i class="fa-duotone fa-sidebar-flip side_baricon"></i>
                        <span class="text-start ps-1">Site Contents</span></a>
                    <ul
                        class="nav-group-sub collapse ms-4 {{ in_array(Route::current()->getName(), ['admin.solution-cms.index', 'solution.create']) ? 'show' : '' }}">
                ...
                <li class="nav-item nav-item-submenu {{ Route::current()->getName() == '' ? 'active' : '' }}">
                    ...
                    <ul class="nav-group-sub collapse ms-4" style="">
                        <li class="nav-item"><a href="{{ route('admin.hr-and-admin.index') }}"
                                class="nav-link">Dashboard</a></li>
                        <li class="nav-item"><a href="{{ route('leaveApplications') }}" class="nav-link">Leave</a>
                        </li>
                        ...
                        <li class="nav-item"><a href="{{ route('admin.job-post.index') }}" class="nav-link">Job
                                Post</a>
                        </li>
                ...
                <li class="nav-item nav-item-submenu {{ Route::current()->getName() == '' ? 'active' : '' }}">
                    ...
                    <ul class="nav-group-sub collapse ms-4" style="">
                        ...
                        <li class="nav-item"><a href="{{ route('admin.marketing.dashboard') }}" class="nav-link">
                                Business</a></li>
                        <li class="nav-item"><a href="{{ route('admin.site-content.index') }}"
                ...
                <li
                    ...
                    <ul
                        ...
                        <li class="nav-item {{ Route::current()->getName() == 'project.dashboard' ? 'active' : '' }}">
