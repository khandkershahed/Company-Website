...
<div class="content-wrapper">
    ...
    <div class="p-1 my-3 content">
        <div class="border-0 row nav-tabs" id="myTab" role="tablist">
            <div class="mx-auto col-lg-10 offset-lg-1">
                <div class="row">
                    <div class="mb-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="text-white border-0 card rounded-1 active bg-primary" id="home-tab"
                            data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab"
                            aria-controls="home" aria-selected="true">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="p-0 m-0">Total Employee</p>
                                    <i class="fa-solid fa-user-tie badge-icons"></i>
                                    <h5 class="p-0 m-0">{{ $employees->count() }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="addEmployee" class="modal fade" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="p-2 px-4 text-white modal-header" style="background-color: #247297">
                ...
                <div class="pt-0 modal-body">
                    <form id="myform" method="post" class="needs-validation"
                        ...
                        <div class="pt-1 pb-2 border-0 modal-footer pe-0">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var button = $(
            '<button class="btn btn-info custom_btn btn-labeled btn-labeled-start"><span class="bg-black btn-labeled-icon bg-opacity-20"><i class="icon-plus2"></i></span>Add</button>'
        );
