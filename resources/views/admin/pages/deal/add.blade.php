            ...
            <div class="d-flex align-items-center justify-content-center">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="my-10 mt-5 text-center">
                        ...
                        <div class="mx-0 col-lg-10">
                            <div class="border-0 shadow-sm card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-5 mb-4">
                                        <div class="repeater">
                                            <div data-repeater-list="contacts" id="repeater-list">
                                                <div data-repeater-item class="row g-1 align-items-center">
                                                    <div class="col-lg-1 col-2">
                                                        <input type="text" name="sl" class="text-center form-control sl" autocomplete="off" value="1" readonly />
                                                    </div>
                                                    <div class="col-lg-9 col-6">
                                                        <input type="text" name="product_name" class="form-control" autocomplete="off" placeholder="Product Name " required />
                                                    </div>
                                                    <div class="col-lg-1 col-2">
                                                        <div class="d-flex">
                                                            <input type="text" name="qty" value="1"
                                                                class="text-center form-control qty" autocomplete="off"
                                                                min="1" readonly style="width: 60px; margin-bottom: 6px;" />
