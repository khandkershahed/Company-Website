{{-- <div class="card-body">
    <form id="stepperForm" action="{{ route('deal.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="step-content active" data-step="1">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mt-4 mb-4 form-check">
                        <div>
                            <input class="form-check-input" type="checkbox" value="" id="resellerCheckbox"
                                required />
            ...
            <div class="mt-5 d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-light-warning me-2 save-draft-step-btn">
                    Save as Draft
                </button>
...
{{-- Receive $rfq variable (will be null on create, populated on edit) --}}
...
<div class="card-body">
    ...
    <form id="stepperForm" action="{{ $rfq ? route('deal.update', $rfq->id) : route('deal.store') }}" method="post"
