                                    ...
                                    <div class="border shadow-sm card">
                                        <div class="py-10 mx-0 row g-0 align-items-center card-header"
                                            ...
                                            <div class="text-white col-lg-2 pe-0">
                                                ...
                                                <div class="mt-2">
                                                    <button type="button" id="btnDraft" class="btn btn-light btn-sm">Add To Draft</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mx-auto col-lg-10">
                                <div class="shadow-sm card rounded-4">
                                    <!-- Card Header -->
                                    <div class="py-10 mx-0 card-header align-items-center" style="background-color: #0b6476">
                                        <div>
                                        ...
                                        <form action="{{ route('admin.quick.deal.store') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row gx-3">
                                                ...
                                                <div class="mt-3 d-flex justify-content-end col-12">
                                                    <button type="submit" class="btn btn-custom btn-primary" style="background-color: #0b6476">
