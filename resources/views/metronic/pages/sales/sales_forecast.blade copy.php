<x-admin-app-layout :title="'Sales Forecast'">
                ...
                <div class="shadow-none card card-flush card-rounded" style="background-color: #296088;">
                    <div class="p-0 py-2 card-body">
                        <div class="p-5 text-center me-3">
                            <h1 class="text-white" style="font-size: 57.801px;">Sales Forecast</h1>
                            ...
                            <div class="p-5 card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="me-3 w-100">
                                        <select name="country" id="filter_country" data-control="select2"
                                            class="form-select form-select-sm form-select-solid w-100">
                                            <option value="" selected>All Countries</option>
                                            @foreach($countryWiseRfqs as $c)
                                                <option value="{{ $c->country }}">{{ $c->country }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="me-3 w-100">
                                        <select name="salesperson" data-control="select2"
                                            class="form-select form-select-sm form-select-solid w-100">
                                    ...
                                    <div class="me-3 w-100">
                                        <select name="period" data-control="select2"
                                            class="form-select form-select-sm form-select-solid w-100">
                                            <option value="month">Month</option>
                                            <option value="quarter">Quarter</option>
                                            <option value="year" selected>YTD</option>
                                        </select>
                                    </div>
                                    <div class="py-2 d-flex align-items-center ms-3 rounded-2">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm me-3">
                                            <input class="form-check-input" type="radio" name="region" value="all" checked>
                                            <label class="form-check-label pe-3">All</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-0 py-4 card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="p-4 text-start me-3">
                                        ...
                                        <h4 class="pt-3 text-black" style="font-size: 28px;">${{ number_format($closed_amount/1000, 2) }}k</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-0 py-4 card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="p-4 text-start me-3">
                                        ...
                                        <h4 class="pt-3 text-black" style="font-size: 28px;">${{ number_format($quoted_amount/1000, 2) }}k</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-0 py-4 card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="p-4 text-start me-3">
                                        ...
                                        <h4 class="pt-3 text-black" style="font-size: 28px;">{{ $weighted_forecast_percent }}%</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="shadow-none card card-flush h-xl-100 bg-gr-b">
                    <div class="mb-5 card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <div class="gap-2 d-flex align-items-center">
                                <img src="https://flagcdn.com/w20/bd.png" class="object-cover shadow-sm rounded-1 w-40px">
                                <img src="https://flagcdn.com/w20/sg.png" class="object-cover shadow-sm rounded-1 w-40px">
                                <img src="https://flagcdn.com/w20/pt.png" class="object-cover shadow-sm rounded-1 w-40px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-0 card-body d-flex justify-content-between flex-column">
                        <div class="flex-wrap gap-5 mb-10 d-flex d-grid">
                            @foreach($contributionData->take(2) as $item)
                            <div class="border-gray-300 border-end-dashed border-end pe-xxl-7 me-xxl-5">
                                <div class="mb-2 d-flex">
                                    ...
                                    <span class="text-gray-800 fs-2hx fw-bold me-2 lh-1 ls-n2">{{ number_format($item->total) }}</span>
                                </div>
                                <span class="text-gray-500 fs-6 fw-semibold">{{ Str::limit($item->brand_name, 8) }}</span>
                            </div>
                            @endforeach
                        </div>
                ...
                <div class="shadow-none card card-flush h-xl-100 bg-gr-g">
                    <div class="card-header pt-7">
                        <div>
                            ...
                            <span>Forecast vs Actual vs Target</span>
                        </div>
                        <div class="card-toolbar">
                            <select name="month" data-control="select2" class="form-select form-select-sm form-select-solid me-3">
                    ...
                    <div class="card-body">
                        <div id="sales_statistics_chart" class="w-100 h-350px"></div>
                    </div>
                </div>
            </div>

            <div class="col-xl-4">
                <div class="card card-flush bg-gr-b" style="height: 450px; overflow-y: scroll;">
                    <div class="card-header pt-7 align-items-center">
                        ...
                        <ul class="nav nav-tabs nav-line-tabs" role="tablist">
                            <li class="nav-item"><a class="nav-link show active" data-bs-toggle="tab" href="#quoted_tab" role="tab">Quoted</a></li>
                            <li class="p-0 nav-item ms-0"><a class="nav-link" data-bs-toggle="tab" href="#closed_tab" role="tab">Closed</a></li>
                            <li class="p-0 nav-item ms-0"><a class="nav-link" data-bs-toggle="tab" href="#lost_tab" role="tab">Lost</a></li>
                        </ul>
                    </div>
                    <div class="card-body d-flex flex-column">
                        <div class="tab-content flex-grow-1">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle table-row-dashed fs-6 gy-3">
                                            <tbody>
                                                @foreach($countryWiseRfqs as $c)
                                                <tr>
                                                    <td class="min-w-50px"><img src="https://flagcdn.com/w20/{{ strtolower($c->country_code ?? 'bd') }}.png" class="w-20px"></td>
                                                    <td class="text-gray-800 fw-bold">{{ $c->country }}</td>
                                                    <td class="text-end"><span class="badge badge-light-primary">{{ $c->total }} Quotes</span></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                            ...
                            <div class="tab-pane fade" id="closed_tab" role="tabpanel">
                                <div class="d-flex flex-center h-100"><p class="text-muted">No Closed Data</p></div>
                            </div>
                            <div class="tab-pane fade" id="lost_tab" role="tabpanel">
                                <div class="d-flex flex-center h-100"><p class="text-muted">No Lost Data</p></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex justify-content-between ms-5">
                                <ul class="nav nav-tabs nav-line-tabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link show active" data-bs-toggle="tab" href="#quotesDeals" role="tab"><span class="fs-6 fw-bold">Quotes</span></a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" data-bs-toggle="tab" href="#mainDeals" role="tab"><span class="fs-6 fw-bold">Deals</span></a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" data-bs-toggle="tab" href="#lostDeals" role="tab"><span class="fs-6 fw-bold">Lost</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div>
                            <form class="mb-5 d-none d-lg-block w-100 mb-lg-0 position-relative">
                                <i class="text-gray-500 fab fa-sistrix fs-2 position-absolute top-50 translate-middle-y ms-4"></i>
                                <input type="text" class="border-gray-200 form-control form-control-solid h-40px ps-13 fs-7" placeholder="Search..." />
                            </form>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            // Function to safely init/re-init DataTables
            function initializeDataTables() {
                $('.dataTable').each(function() {
                    if ($.fn.DataTable.isDataTable(this)) {
                        $(this).DataTable().destroy(); // Destroy existing instance
                    }
                });
                
                $('.dataTable').DataTable({
                    "fixedHeader": { "header": true, "headerOffset": 5 },
            ...
            if (typeof ApexCharts !== 'undefined') {
                var options = {
                    series: [{ name: 'Forecast', data: @json($forecastData) }, { name: 'Actual', data: @json($actualData) }, { name: 'Target', data: @json($targetData) }],
                    chart: { type: 'bar', height: 350, toolbar: {show:false} },
                    plotOptions: { bar: { horizontal: false, columnWidth: '55%', borderRadius: 4 } },
                    dataLabels: { enabled: false },
                    stroke: { show: true, width: 2, colors: ['transparent'] },
                    xaxis: { categories: @json($months) },
                    colors: ['#7239ea', '#50cd89', '#ffc700'],
                };
                
                if(document.querySelector("#sales_statistics_chart")) {
                     new ApexCharts(document.querySelector("#sales_statistics_chart"), options).render();
                }
            }
            ...
            function fetchFilteredData(country = '') {
                $.ajax({
                    ...
                    success: function(response) {
                        $('#filteredContainer').html(response);
                        initializeDataTables(); // Re-init DataTables on new HTML
                    }
                });
            }
