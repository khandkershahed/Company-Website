                                    ...
                                    <div class="d-flex flex-stack justify-content-between">
                                        <div class="d-flex align-items-center me-3 w-50 rounded-3">
                                            <span class="p-3 rounded-3 me-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                                    <mask id="mask0_1058_4843" style="mask-type:alpha"
                                    ...
                                    <div class="d-flex flex-stack justify-content-between">
                                        <div class="d-flex align-items-center me-3 w-50 rounded-3">
                                            <span class="p-3 rounded-3 me-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                                    <mask id="mask0_300_1454" style="mask-type:alpha"
                                                        maskUnits="userSpaceOnUse" x="0" y="0" width="24"
                                                        height="24">
                                                        <rect width="24" height="24" fill="#D9D9D9" />
                                                    </mask>
                                    ...
                                    <div class="d-flex flex-stack justify-content-between">
                                        <div class="d-flex align-items-center me-3 w-50 rounded-3">
                                            <span class="p-3 rounded-3 me-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                                    <mask id="mask0_300_1461" style="mask-type:alpha"
                                                        maskUnits="userSpaceOnUse" x="0" y="0" width="24"
                                                        height="24">
                                                        <rect width="24" height="24" fill="#D9D9D9" />
                                                    </mask>
            ...
            <div class="col-xl-4 ps-0">
                <div class="shadow-none card card-flush card-rounded">
                    ...
                    <div class="px-8 card-header align-items-center">
                        ...
                        <div>
                            <span class="pe-4">
                                <a class="fs-6" style="color: #296088;"
                                    href="{{ route('admin.sales.forecast') }}">Sales Forecast</a>
                                <span>|</span>
                            ...
                            <div class="tab-pane fade show active" id="currentMonthSales" role="tabpanel">
                                <div class="border table-responsive rounded-4">
                                    <table class="table my-0 align-middle table-row-dashed table-borderd gs-0 gy-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center text-muted" colspan="5"> No Data Available
                                                </td>
                                                {{-- <td class="ps-4">
                                                    1
                                                </td>
                                ...
                                <div class="table-responsive">
                                    <table class="table my-0 align-middle table-row-dashed table-borderd gs-0 gy-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="text-gray-600 fw-bold fs-6">1</span>
                                                </td>
                                                <td>
                                                    <span class="text-gray-600 fw-bold fs-6"> 1 Jan 2025</span>
                                                </td>
                                                <td class="text-center">
                ...
                <div class="shadow-none card card-flush card-rounded">
                    ...
                    <div class="py-10 card-body">
                        <div class="h-250px d-flex justify-content-center align-items-center">
                            <img class="img-fluid" src="{{ asset('/images/sales-chart.png') }}"
                ...
                <div class="shadow-none card card-flush card-rounded">
                    ...
                    <div class="py-10 card-body">
                        <div class="h-200px d-flex justify-content-center align-items-center">
                            <img class="img-fluid" src="{{ asset('/images/rounde-chart.png') }}"
                                class="bottom-0 position-absolute me-3 end-0 h-200px" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="shadow-none card card-flush card-rounded">
                    <div class="card-body d-flex justify-content-between flex-column">
                        ...
                        <div class="text-black">
                            <a href="#" class="optional-color">Closed</a><span class="mx-1">|</span><a
                                href="" class="text-black">Quoted</a><span class="mx-1">|</span><a
                                href="" class="text-black">Potential</a><span class="mx-1">|</span><a
                                href="" class="text-black">Lost</a>
                        </div>
                    </div>
                                            ...
                                            <a href="" class="text-black">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16"
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M7 12.3857C11.2294 12.3857 13.186 11.8432 13.375 9.66538C13.375 7.4891 12.0109 7.62904 12.0109 4.95883C12.0109 2.87311 10.0339 0.5 7 0.5C3.96608 0.5 1.98914 2.87311 1.98914 4.95883C1.98914 7.62904 0.625 7.4891 0.625 9.66538C0.814714 11.8514 2.77133 12.3857 7 12.3857Z"
                                                        stroke="#130F26" stroke-width="0.65625"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path
                                                        d="M8.79153 14.6431C7.76842 15.7791 6.17242 15.7926 5.13953 14.6431"
                                                        stroke="#130F26" stroke-width="0.65625"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                                2 Days Pending
                                        ...
                                        <td class="text-end pe-4">
                                            <a href="" class="px-3 py-1 btn btn-outline-primary btn-sm">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M19.25 14.334V5.665C19.25 2.645 17.111 0.75 14.084 0.75H5.916C2.889 0.75 0.75 2.635 0.75 5.665L0.75 14.334C0.75 17.364 2.889 19.25 5.916 19.25H14.084C17.111 19.25 19.25 17.364 19.25 14.334Z"
                                                        stroke="#A1A1A1" stroke-width="1.5" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path d="M14.0859 10H5.91394" stroke="#A1A1A1" stroke-width="1.5"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M10.3223 6.25205L14.0863 10L10.3223 13.748"
                                                        stroke="#A1A1A1" stroke-width="1.5" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </svg>
                                            </a>
