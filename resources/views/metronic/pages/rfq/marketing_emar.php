                    ...
                    <div class="p-0 card-header align-items-center">
                        ...
                        <ul class="border-0 nav nav-tabs nav-line-tabs fs-6 align-items-center" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="border-0 nav-link active" data-bs-toggle="tab" href="#tab_all" role="tab">All Email</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="border-0 nav-link" data-bs-toggle="tab" href="#tab_draft" role="tab">Draft Email</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="border-0 nav-link" data-bs-toggle="tab" href="#tab_draft" role="tab">Sent Email</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="border-0 nav-link" data-bs-toggle="tab" href="#tab_deleted" role="tab">Deleted Email</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tab_all">
                                <div class="border table-responsive rounded-4">
                                    <table class="table table-row-bordered gy-5 gs-7 dataTable no-footer" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                                        <thead>
                                            <tr class="bg-light fw-bold ">
                                                <th style="width: 55.7031px;" class="sorting sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending"
