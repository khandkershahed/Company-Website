    ...
    <div class="row">
        <div class="col-lg-5 ps-0">
            <div class="card" style="border-radius: 24px;">
                <div class="pt-5 border-0 card-header px-4">
                    <div class="d-flex align-items-center">
                        <div class="me-2">
                            <select class="py-4 form-select form-select-solid form-select-sm me-2 rounded-3 fixed-width-select" data-control="select2"
                        ...
                        <div class="me-2">
                            <select class="py-4 form-select form-select-sm me-2 rounded-3 fixed-width-select" data-control="select2">
                                    ...
                                    <div class="row w-100 align-items-center">
                                        <div class="col-md-6 d-flex align-items-center">
                                            <div class="text-start ps-4">
                                                <div class="text-black fw-normal">
                                                    <h1 style="font-size: 16px; font-weight: 400;">{{ $rfq->name }}</h1>
                                                </div>
                                                <div class="text-muted fw-normal mt-1" style="font-size: 14px;">
                                        ...
                                        <div class="col-md-6 text-end pe-0">
                                            <div class="fs-7 text-danger d-flex align-items-center justify-content-end">
                                                <img class="img-fluid fa-shake me-2" width="15px" src="{{ asset('/images/Notification.svg') }}" alt="">
                                                {{ \Carbon\Carbon::parse($rfq->created_at)->diffInDays(now(), false) }} Days
                                            </div>
                                            <div>
                                            ...
                                            <div class="gap-2 mb-1 d-flex justify-content-end">
                                                <div>
                                                    <select class="form-select"
                                                        style="background-color: #296088 !important; width: 200px !important;"
                                                        data-control="select2"
                                                        data-placeholder="Assign">
                                                        <option></option>
        ...
        <div class="col-lg-5 ps-0">
            <div class="card border-0" style="border-radius: 24px;">
                <div class="pt-5 border-0 card-header px-4">
                    <div class="d-flex align-items-center">
                        <div class="me-2">
                            <select class="py-4 form-select form-select-solid form-select-sm me-2 rounded-3" data-control="select2"
                                id="filterCountry" name="country">
                                <option selected disabled>Country</option>
                                @foreach ($countries as $country)
                                <option value="{{ $country }}">{{ $country }}</option>
                                        ...
                                        <div class="col-md-6 d-flex align-items-center">
                                            ...
                                            <div class="text-black text-start">
                                                ...
                                                <div class="fs-7 text-muted">
                                                    @if (!Route::is('admin.archived.rfq'))
                                                    RFQ#
                                                    @endif{{ $quoted_rfq->rfq_code }}|{{ $quoted_rfq->country }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 text-end pe-0">
                                            ...
                                            <div>
                                                <p class="py-2 mb-0 fw-normal text-muted"> {{ optional($rfq->created_at)->format('d M Y | h:i A') }}</p>
                                            </div>
                                            <div class="gap-2 mb-1 d-flex justify-content-end">
                                                <div>
