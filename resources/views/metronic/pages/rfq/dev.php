            ...
            <div class="card-body">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="mb-3 col-12">
                        <ul class="flex-wrap gap-3 mb-0 border-0 nav nav-tabs nav-line-tabs fs-6 rfq-tabs d-flex w-100">
                    ...
                    <div class="mb-3 col-12">
                        <div class="flex-wrap gap-3 d-flex">
                            <!-- Search -->
                            <div class="flex-grow-1">
                                <div class="text-white rounded position-relative d-flex align-items-center">
                                    <i class="fa-solid fa-magnifying-glass fs-3 position-absolute top-50 translate-middle-y ms-4"></i>
                    ...
                    <div class="col-12">
                        <div class="gap-3 d-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
                            <!-- Country -->
                            <div>
                                <select class="form-select w-100 filterCountry"
                            ...
                            <!-- Salesman -->
                            <div>
                                <select class="form-select w-100 filterSalesman"
                                    data-control="select2" data-allow-clear="true" data-enable-filtering="true">
                            ...
                            <!-- Company -->
                            <div>
                                <select class="form-select w-100 filterCompany"
                                    data-control="select2" data-allow-clear="true" data-enable-filtering="true"
