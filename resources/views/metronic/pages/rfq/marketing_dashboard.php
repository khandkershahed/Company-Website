                            ...
                            <div class="d-flex flex-stack justify-content-between">
                                <div class="d-flex align-items-center me-3 w-50 rounded-3">
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="pt-1 text-gray-500 fw-semibold d-block fs-6">22 Mar 2025</span>
                                    </div>
                                </div>
                                <div class="flex-column d-flex w-50">
                                    <div class="d-flex align-items-center justify-content-between pe-3">
                                        <span class="text-gray-500 fw-semibold"></span>
                                        <span class="px-2 ms-3 rounded-2 fs-1 fw-bold">150$</span>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3 d-flex flex-stack justify-content-between">
                                <div class="d-flex align-items-center w-50 rounded-3">
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="pt-1 text-gray-500 fw-semibold d-block fs-6">FY25</span>
                                    </div>
                                </div>
                                <div class="flex-column d-flex w-50">
                                    <div class="d-flex align-items-center justify-content-between pe-3">
                                    ...
                                    <div class="d-flex flex-stack justify-content-between">
                                        ...
                                        <div class="flex-column d-flex w-50">
                                            <div class="d-flex align-items-center justify-content-between pe-3">
                                                ...
                                                <span class="px-2 text-black ms-3 rounded-2 fs-1">15000$</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-stack justify-content-between">
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex flex-stack justify-content-between">
                                        ...
                                        <div class="flex-column d-flex w-50">
                                            <div class="d-flex align-items-center justify-content-between pe-3">
                                                <span class="text-black fw-semibold"></span>
                                                <span class="px-2 text-black ms-3 rounded-2 fs-1">120</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-stack justify-content-between">
                                        ...
                                        <div class="flex-column d-flex w-50">
                                            <div class="d-flex align-items-center justify-content-between pe-3">
                                                <span class="text-black fw-semibold"></span>
                                                <span class="px-2 text-black ms-3 rounded-2 fs-1 ">5</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-xl-4 ps-0">
                <div class="shadow-none card card-flush card-rounded">
                    ...
                    <div class="px-8 card-header align-items-center">
                        ...
                        <div>
                            <span class="pe-4">
                                <a class="fs-6" style="color: #296088;" href="/super-admin/sales-forecast">Sales Forecast</a>
                                <span>|</span>
                                <a class="fs-6 text-muted" href="/super-admin/sales-report">Report</a>
                            </span>
                        </div>
                    </div>
