<x-admin-app-layout :title="'Sales Dashboard'">
    <div class="p-0 container-fluid">
        <div class="mb-5 row gx-2 gx-xl-5">
            <div class="col-xl-3">
                <div class="shadow-none card card-flush">
                    <div class="p-2 card-body" style="height: 142px;position: relative;top: 22px;">
            ...
            <div class="col-xl-3">
                <div class="shadow-none card card-flush">
                    <div class="p-2 card-body" style="height: 142px;">
                        <div class="d-flex flex-stack justify-content-between">
                            <div class="p-8 d-flex align-items-center me-3 w-50 rounded-3">
                                <a href="">
                                ...
                                <div class="flex-grow-1">
                                    <a href="#" class="text-gray-800 fs-5 fw-bold lh-0">Followup
                                        <span class="pt-4 text-gray-500 fw-semibold d-block fs-6">All List</span>
                                    </a>
                                </div>
                            ...
                            <div class="flex-column d-flex w-50">
                                ...
                                <div class="px-3 py-3 d-flex align-items-center justify-content-between rounded-2 bg-light">
                                    <span class="text-gray-500 fw-semibold">
                                        Email</span>
                                    <span class="px-2 fw-semibold ms-3 text-primary rounded-2">
                                        300
                ...
                <div class="shadow-sm card card-flush h-xl-100">
                    ...
                    <div class="pt-6 card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="" class="text-blue-400" style="text-decoration: underline;">
                                    <i class="fas fa-hand-point-right text-warning" aria-hidden="true"></i>
                                    Go to DMAR File
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive rounded-4">
                                    <table class="table align-middle table-row-dashed gs-0 gy-4">
                                        <thead class="bg-light">
                                            <tr class="border-0 text-light-500 fs-7 fw-bold">
                                                <th class="ps-2">SL</th>
            ...
            <div class="col-xl-4">
                <div class="shadow-sm card card-flush h-xl-100">
                    ...
                    <div class="py-3 card-header align-items-center">
                        <div>
                            <ul class="border-0 nav nav-tabs nav-pills nav-pills-custom fs-6">
                                <li class="nav-item">
                                    <a class="py-2 text-black nav-link active" data-bs-toggle="tab" href="#swGrowth">SW</a>
                                </li>
                                <li class="nav-item">
                                    <a class="py-2 text-black nav-link" data-bs-toggle="tab" href="#hwGrowth">HW</a>
                                </li>
                                <li class="nav-item">
                                    <a class="py-2 text-black nav-link" data-bs-toggle="tab" href="#saGrowth">Solution - All</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div class="mt-5 card-body d-flex justify-content-between flex-column">
                        <div class="tab-content" id="myTabContent">
                            <div class="mt-5 tab-pane fade show active" id="swGrowth" role="tabpanel">
        ...
        <div class="row gx-2 gx-xl-5">
            ...
            <div class="col-xl-8">
                <div class="shadow-sm card h-md-100">
                    <div class="card-header position-relative border-bottom-1">
                        <h3 class="card-title">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div>
                                <select class="form-select form-select-sm select2-hidden-accessible"
                                    data-control="select2" data-placeholder="Choose Country" tabindex="-1" aria-hidden="true">
                                    <option></option>
                                    <option value="1">Bangladesh</option>
                                    <option value="2">Singapore</option>
                                    <option value="2">Europe</option>
                            ...
                            <div class="tab-pane active" id="kt_timeline_widget_4_tab_day" role="tabpanel" aria-labelledby="day-tab">
                                <div class="border table-responsive rounded-4">
                                    <table class="table my-0 align-middle table-row-dashed gs-0 gy-3">
                                        <thead class="py-3 bg-light">
                                            <tr class="p-3 text-gray-500 fs-7 fw-bold border-bottom-0">
                                                <th class="ps-3">SL</th>
                                                <th class="">Salesman</th>
                                                <th class="">Week / Month / Quarter</th>
                                                <th class="">DMAR (% + graph)</th>
                                                <th class="">EMAR (% + graph)</th>
                                                <th class="">CMAR (% + graph)</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end pe-3">Complete</td>
                                            </tr>
                                            <tr>
                                                <td class="ps-3">02</td>
                                                <td class="pe-0">Rohit Shetti</td>
