                ...
                <div class="shadow-sm card h-md-100">
                    <div class="pt-5 border-0 card-header">
                        ...
                        <div class="card-toolbar">
                            <a href="marketing-dmr-target.html" class="text-black btn btn-sm btn-light-primary ms-3"
                                style="background-color: #F2F4F6 !important;font-weight: 400; ">
                                Report Center
                            </a>
                        </div>
                    </div>
                    <div class="px-0 py-4 pt-4 card-body">
                            ...
                            <div>
                                ...
                                <div class="py-2 mt-3 bg-white d-flex align-items-center me-3 rounded-2">
                                    <div class="form-check form-check-custom form-check-solid form-check-sm me-3">
                                        ...
                                        <input class="form-check-input" type="radio" name="group3" value="TK"
                                            id="radioTK" checked="">
                                    </div>
                                    <div class="form-check form-check-custom form-check-solid form-check-sm me-3">
                        ...
                        <div class="px-3 mb-2 tab-content">
                            <div class="mt-4 tab-pane fade active show" id="kt_timeline_widget_3_tab_content_1"
                                role="tabpanel">
                                <!-- Jan Content -->
