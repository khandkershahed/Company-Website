 <x-admin-app-layout :title="'Edit RFQ Form'">
                            ...
                            <div class="mt-5 row justify-content-center">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-5 text-center">
                                        <h1 class="mb-0 rfq-title fw-bold text-primary">Edit RFQ Information</h1>
                                        <div class="mt-2">
                                ...
                                <div class="px-0 mx-0 col-lg-10 col-12 px-lg-auto">
                                    ...
                                    <div class="border shadow-sm card">
                                        {{-- Card Header with Sales Manager and RFQ Info --}}
                                        <div class="py-10 mx-0 row g-0 align-items-center card-header" style="background-color: #0b6476">
                                            ...
                                            <div class="text-white col-lg-2 pe-5 text-end">
                                                <h4 class="text-white fw-bold mb-1 fs-6"> RFQ Information </h4>
                                        ...
                                        @include('metronic.pages.rfq.partials.rfq_form', ['rfq' => $rfq])
