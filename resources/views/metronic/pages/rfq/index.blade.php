                            ...
                            <div class="d-flex flex-stack justify-content-between align-items-center">
                                <div class="p-8 d-flex align-items-center me-3 rounded-3">
                                    <a href="javascript:void(0)">
                                        <span
                                            class="p-3 bg-light-primary rounded-3 me-3 fs-1 text-black d-flex align-items-center justify-content-center">
                                            {{ $rfq_count }}
                                        </span>
                                    </a>
                                ...
                                <div class="flex-grow-1 text-center">
                                    <a href="javascript:void" class="text-gray-800 fs-1 fw-bold lh-0">
                                        <span class="pt-4 text-gray-500 fw-semibold d-block fs-6 mb-2 text-start">
