        ...
        <div class="mb-10 row">
            ...
            <div class="col-xl-3">
                <div class="shadow-none card card-flush card-rounded">
                    <div class="p-0 card-body">
                        <div
                            class="px-4 d-flex flex-stack justify-content-center align-items-center h-268px">
                            <div class="d-flex align-items-center rounded-3" style="width: 50%;">
                                <div class="me-2">
                                    <img class="img-fluid" width="30px" src="{{ asset('/images/campaign.svg') }}" alt="">
                                </div>
                                <div class="ps-3">
                                    <a href="">
                                        <div class="flex-grow-1">
                                            <a
                                                href="#"
                                                class="text-gray-800 fs-2 fw-bold lh-0">MARKETING
                                            </a> <br />
                            ...
                            <div class="px-4 flex-column d-flex" style="width: 50%;">
                                <div class="p-2 mb-2 d-flex align-items-center justify-content-between bg-light rounded-2">
                                    <span class="text-black ">
                                        EMAILED
                                    </span>
                                    <span
                                        class="px-2 text-black ms-3 rounded-2">
                                        150
                                    </span>
                                </div>
                                <div
                                ...
                                <div
                                    class="p-2 d-flex align-items-center justify-content-between rounded-2" style="background-color: #296088;">
                                    <span class="text-white"> Total</span>
                                    <span
                                        class="px-2 text-white ms-3 rounded-2">
                                        300
                                    </span>
                                </div>
                            </div>
                ...
                <div class="shadow-none card card-flush card-rounded">
                    <div class="p-0 card-body">
                        <div
                            class="px-4 d-flex flex-stack justify-content-center align-items-center h-268px">
                            <div
                                class="d-flex align-items-center rounded-3" style="width: 50%;">
                                <div class="me-2">
                                    <img class="img-fluid" width="30px" src="{{ asset('/images/Frame.svg') }}" alt="">
                                </div>
                                <div class="ps-3">
                                    <a href="">
                                        <div class="flex-grow-1">
                                            <a
                                                href="#"
                                                class="text-gray-800 fs-2 fw-bold lh-0">SALES
                                            </a> <br />
                                            <p class="mt-2 mb-0">For This Month Only</p>
                                        </div>
                                    </a>
            ...
            <div class="shadow-none card card-flush card-rounded">
                <div class="py-10 card-header w-100 justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="marketing-dmr-target.html" class="text-white btn btn-sm btn-light-primary bg-primary ms-3" style="background-color: #0B6476 !important;">
