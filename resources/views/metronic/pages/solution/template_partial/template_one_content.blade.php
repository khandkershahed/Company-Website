                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 border mb-7">
                        ...
                        <div class="mb-7">
                            ...
                            <textarea name="row_five_description" rows="8" class="ckeditor mb-2 form-control" placeholder="Description">{{ old('row_five_description', $solution->row_five_description) }}
                            </textarea>
                        </div>
                        <div class="mb-7">
                    ...
                    <div class="col-lg-6 border mb-7">
                        ...
                        <div class="mb-7">
                            <x-metronic.label class="form-label required">Description</x-metronic.label>
                            <textarea name="row_seven_description" rows="8" class="ckeditor mb-2 form-control" placeholder="Description">{{ old('row_seven_description', $solution->row_seven_description) }}
                            </textarea>
                        </div>
                        <div class="mb-7">
                            <x-metronic.label class="form-label">Link</x-metronic.label>
