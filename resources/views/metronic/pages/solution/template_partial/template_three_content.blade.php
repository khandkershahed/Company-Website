<div class="row">
        ...
        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column  mb-3 mb-md-0 fs-6">
            <li class="nav-item mb-3">
                <a class="nav-link active btn btn-flex btn-active-success w-100" data-bs-toggle="tab"
                    href="#template_three_section_one">
                    <div class="d-flex flex-column align-items-start">
                        <img src="{{ asset('images/solution/template_three/section_one.png') }}" alt=""
                            width="180px">
                    </div>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link btn btn-flex btn-active-info w-100" data-bs-toggle="tab"
                    href="#template_three_section_two">
                    <div class="d-flex flex-column align-items-start">
                        <img src="{{ asset('images/solution/template_three/section_two.png') }}" alt=""
                            width="180px">
                    </div>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link btn btn-flex btn-active-danger w-100" data-bs-toggle="tab"
                    href="#template_three_section_three">
                    <div class="d-flex flex-column align-items-start">
                        <img src="{{ asset('images/solution/template_three/section_three.png') }}" alt=""
                            width="180px">
                    </div>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link btn btn-flex btn-active-danger w-100" data-bs-toggle="tab"
                    href="#template_three_section_four">
                    <div class="d-flex flex-column align-items-start">
                        <img src="{{ asset('images/solution/template_three/count.png') }}" alt=""
                            width="180px">
                    </div>
                </a>
            </li>
    ...
    <div class="col-lg-9">
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="template_three_section_one" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-7">
                        ...
                        <x-metronic.input type="text" name="row_four_link" class="mb-2 form-control"
                            placeholder="Title" :value="old('row_four_link', $solution->row_four_link)">
                        </x-metronic.input>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.file-input id="row_four_small_image" name="row_four_small_image" :source="asset('storage/' . $solution->row_four_small_image)"
                            :value="old('row_four_small_image')"></x-metronic.file-input>
                    </div>
                    ...
                    <div class="col-lg-12 mb-7">
                        ...
                        <textarea name="row_four_header" rows="3" class="ckeditor mb-2 form-control" placeholder="Description">{{ old('row_four_header', $solution->row_four_header) }}
                        </textarea>
                    </div>
                    ...
                    <div class="col-lg-5 mb-7">
                        ...
                        <x-metronic.input type="text" name="row_four_col_one_description"
            ...
            <div class="tab-pane fade" id="template_three_section_two" role="tabpanel">
                <div class="col-lg-12 mb-7">
                    <x-metronic.label class="form-label required">Title</x-metronic.label>
            ...
            <div class="tab-pane fade" id="template_three_section_three" role="tabpanel">
                <div class="col-lg-12 mb-7">
                    <x-metronic.label class="form-label required">Title</x-metronic.label>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-7 border p-4">
                        <div class="mb-7">
                        ...
                        <div class="mb-7">
                            ...
                            <x-metronic.input type="text" name="row_two_column_one_title"
                                class="mb-2 form-control" placeholder="Column One Title" :value="old('row_two_column_one_title', $solution->row_two_column_one_title)">
                            </x-metronic.input>
                        </div>
                        <div class="mb-7">
                    ...
                    <div class="col-lg-6 mb-7 border p-4">
                        ...
                        <div class="mb-7">
                            ...
                            <x-metronic.input type="text" name="row_two_column_two_title"
                                class="mb-2 form-control" placeholder="Column two Title" :value="old('row_two_column_two_title', $solution->row_two_column_two_title)">
                            </x-metronic.input>
                        </div>
                        <div class="mb-7">
            ...
            <div class="tab-pane fade" id="template_three_section_four" role="tabpanel">
                <div class="row">
                    <div class="col-lg-6 mb-7 border p-4">
                        <div class="mb-7">
