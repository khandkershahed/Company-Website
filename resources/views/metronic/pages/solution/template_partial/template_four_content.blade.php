        ...
        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column  mb-3 mb-md-0 fs-6">
            <li class="nav-item mb-3">
                <a class="nav-link active btn btn-flex btn-active-success w-100" data-bs-toggle="tab"
                    ...
                    <div class="d-flex flex-column align-items-start">
                        <img src="{{ asset('images/solution/template_four/section_one.png') }}" alt=""
                            width="200px">
                    </div>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link btn btn-flex btn-active-info w-100" data-bs-toggle="tab"
                    ...
                    <div class="d-flex flex-column align-items-start">
                        <img src="{{ asset('images/solution/template_four/section_two.png') }}" alt=""
                            width="200px">
                    </div>
                </a>
            </li>
            <li class="nav-item mb-3">
                <a class="nav-link btn btn-flex btn-active-danger w-100" data-bs-toggle="tab"
                    ...
                    <div class="d-flex flex-column align-items-start">
                        <img src="{{ asset('images/solution/template_four/section_three.png') }}" alt=""
                            width="200px">
                    </div>
                </a>
            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 p-4">
                        <div class="row border p-4">
                            <div class="col-lg-12 mb-7">
                                <x-metronic.label class="form-label required">Column One Title</x-metronic.label>
                            ...
                            <div class="col-lg-12 mb-7">
                                <x-metronic.label class="form-label required">Column One Text</x-metronic.label>
                                <x-metronic.input type="text" name="row_four_col_one_description"
                                    class="mb-2 form-control" placeholder="Text" :value="old(
                                        'row_four_col_one_description',
                                        $solution->row_four_col_one_description,
                                    )">
                                </x-metronic.input>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 p-4">
                        <div class="row border p-4">
                            <div class="col-lg-12 mb-7">
                                <x-metronic.label class="form-label required">Column Two Title</x-metronic.label>
                            ...
                            <div class="col-lg-12 mb-7">
                                <x-metronic.label class="form-label required">Column Two Text</x-metronic.label>
                                <x-metronic.input type="text" name="row_four_col_two_description"
                                    class="mb-2 form-control" placeholder="Text" :value="old(
                                        'row_four_col_two_description',
                                        $solution->row_four_col_two_description,
                                    )">
                                </x-metronic.input>
                            </div>
                        </div>
