                ...
                <div class="row">
                                ...
                                <div class="d-flex flex-stack justify-content-between">
                                    <div class="p-8 d-flex align-items-center me-3 rounded-3">
                                        ...
                                        <div class="flex-grow-1"><a href="">
                                            </a><a href="#" class="text-white fs-5 fw-bold lh-0">Employee
                                                <span
                    ...
                    <div class="col-xl-12">
                        <div class="mt-5 border shadow-none card">
                            ...
                            <div class="pt-0 card-body" style="overflow: auto;">
                ...
                <div class="p-4 border shadow-none card">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-pills nav-pills-custom d-flex justify-content-center align-items-center w-100" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="p-3 mt-5 overflow-hidden nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column rounded-0"
