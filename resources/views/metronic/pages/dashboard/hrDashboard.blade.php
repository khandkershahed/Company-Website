                            ...
                            <div class="bg-white border-0 card-header align-items-center">
                                ...
                                <div>
                                    <ul class="nav nav-tabs nav-line-tabs fs-6">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#allAttendance">All
                                                Attendance</a>
                                        </li>
                                        <li class="nav-item">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="javascript:void(0);"
                                                                    class="btn btn-sm btn-icon btn-primary printBtn">
                                                                    <i class="text-white fas fa-file fs-6"
                                                                        title="Print Application"
                                                                        aria-hidden="true"></i><span
                                                                        class="sr-only">Print Application</span>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                ...
                <div class="border shadow-none card">
                        ...
                        <ul class="nav nav-pills nav-pills-custom" role="tablist">
                            <li class="m-0 nav-item" role="presentation">
                                <a class="pt-5 pb-2 overflow-hidden nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column rounded-0 h-100 active"
                                    id="kt_stats_widget_16_tab_link_4" data-bs-toggle="pill" href="#all-meeting"
                            ...
                            <li class="m-0 nav-item" role="presentation">
                                <a class="pt-5 pb-2 overflow-hidden nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column rounded-0 h-100"
                                    id="kt_stats_widget_16_tab_link_1" data-bs-toggle="pill" href="#task-shedule"
                    ...
                    <div class="p-0 pt-4 card-body">
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="all-meeting" role="tabpanel"
                                ...
                                <div>
                                    <ul class="px-3 mb-8 nav nav-stretch nav-pills nav-pills-custom nav-pills-active-custom d-flex justify-content-between"
                                        ...
                                        <li class="p-0 nav-item ms-0" role="presentation">
                                            <a class="px-3 py-4 nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px btn-active-danger active"
                                        ...
                                        <li class="p-0 nav-item ms-0" role="presentation">
                                            <a class="px-3 py-4 nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px btn-active-danger"
                                    ...
                                    <div class="px-4 mb-2 tab-content">
                                        <div style="height: 730px; overflow: auto" class="tab-pane fade show active"
                                            ...
                                            <div class="mb-6 d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 me-5">
                                                    ...
                                                    <div class="text-gray-500 fw-semibold fs-7">
                                                        Lead by
                                                        <a href="#"
                                                            class="text-primary opacity-75-hover fw-semibold">Minhajul
                                                            Islam</a>
                                                    </div>
                                                </div>

                                                <a class="btn btn-sm btn-light" href="javascript:void(0)"
                                                    data-bs-toggle="modal" data-bs-target="#create-meeting">View</a>
                                            </div>
                                            <div class="mb-6 d-flex align-items-center">
                                                <span data-kt-element="bullet"
                                                ...
                                                <div class="flex-grow-1 me-5">
                                                    ...
                                                    <div class="text-gray-500 fw-semibold fs-7">
                                                        Lead by
                                                        <a href="#"
                                                            class="text-primary opacity-75-hover fw-semibold">CEO
                                                            Sir</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-6 d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 me-5">
                                                    ...
                                                    <div class="text-gray-500 fw-semibold fs-7">
                                                        Lead by
                                                        <a href="#"
                                                            class="text-primary opacity-75-hover fw-semibold">Faysal
                                                            Mahmud</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-6 d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 me-5">
                                                    ...
                                                    <div class="text-gray-500 fw-semibold fs-7">
                                                        Lead by
                                                        <a href="#"
                                                            class="text-primary opacity-75-hover fw-semibold">Khandaker
                                                            Shahed</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-6 d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 me-5">
                                                    ...
                                                    <div class="text-gray-500 fw-semibold fs-7">
                                                        Lead by
                                                        <a href="#"
                                                            class="text-primary opacity-75-hover fw-semibold">Akash
                                                            Mirza With Team</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-6 d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 me-5">
                                                    ...
                                                    <div class="text-gray-500 fw-semibold fs-7">
                                                        Lead by
                                                        <a href="#"
                                                            class="text-primary opacity-75-hover fw-semibold">Nahidul
                                                            Islam</a>
                                                    </div>
                                                </div>
                            ...
                            <!-- Al Shedule Tabs End -->
                            <div class="tab-pane fade" id="kpi-details" role="tabpanel"
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="mb-5 d-flex align-items-center">
                                                ...
                                                <div class="fw-semibold">
                                                    <a class="text-gray-900 fs-6 fw-bold text-hover-primary"
                                                ...
                                                <button type="button"
                                                    class="btn btn-sm btn-icon btn-icon-primary btn-active-light-primary ms-auto">
