                                ...
                                <div class="text-white fs-4">
                                    ...
                                    <span class="position-relative d-inline-block">
                                        <a href="javascript:void(0);"
                                            ...
                                            {{ optional(Auth::user()->employeeLeave)->total_leave - (optional(Auth::user()->employeeLeave)->casual_leave_availed + optional(Auth::user()->employeeLeave)->earned_leave_availed + optional(Auth::user()->employeeLeave)->medical_leave_availed) ?? 00 }} remaining leave
                                            days</a>
                    ...
                    <div class="row gx-9">
                        <div class="col-sm-6" style="border-right: 1px solid #eee;">
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                ...
                                <span class="px-4 py-3 text-white bg-primary rounded-circle">{{ sprintf('%02d', optional(Auth::user()->employeeLeave)->total_leave ?? 0) }}</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                <span class="text-black fw-semibold">This Month Total:</span>
                                <span class="px-4 py-3 text-white bg-primary rounded-circle">{{ sprintf('%02d', (Auth::user()->category_id == 1) ? 2 : 1) }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row gx-9 border-top">
                        <div class="col-sm-6" style="border-right: 1px solid #eee;">
                            <div class="mt-3 d-flex justify-content-between align-items-center">
                                ...
                                <span class="px-4 py-3 text-white bg-primary rounded-circle">{{ sprintf('%02d', 
                                    (optional(Auth::user()->employeeLeave)->casual_leave_availed ?? 0) +
                                    (optional(Auth::user()->employeeLeave)->earned_leave_availed ?? 0) +
                                    (optional(Auth::user()->employeeLeave)->medical_leave_availed ?? 0)
                                ) }}</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mt-3 d-flex justify-content-between align-items-center">
                                ...
                                <span class="px-4 py-3 text-white bg-primary rounded-circle">00</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pb-3 row gx-9">
                        <div class="col-sm-6" style="border-right: 1px solid #eee;">
                            <div class="mb-5 d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="p-3 py-1 text-white bg-primary rounded-pill">{{ !empty($todayAttendance->check_in) ? $todayAttendance->check_in : 'Absent' }}</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-5 d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="p-3 py-1 text-white bg-primary rounded-pill">{{ !empty($todayAttendance->check_in) ? (!empty($todayAttendance->check_out) ? $todayAttendance->check_out : 'N/A') : 'Absent' }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row gx-9 border-top">
                        <div class="col-sm-12">
                            <div class="mt-6 d-flex justify-content-between align-items-center">
                                ...
                                <span class="p-4 py-2 text-white badge badge-primary rounded-pill">
                                    LL: {{ $attendances->filter(fn($a) => $a['check_in'] > '10:00:00')->count() }}
                                </span>

                                <span class="p-4 py-2 text-white badge badge-warning rounded-pill">
                                    A: {{ $attendances->filter(fn($a) => is_null($a['check_in']))->count() }}
                                </span>
                                <span class="p-4 py-2 text-white badge badge-success rounded-pill">
                                    Critical Point = 0
                                </span>
