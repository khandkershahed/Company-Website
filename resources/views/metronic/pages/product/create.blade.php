                ...
                <div class="col-lg-2" style="border-right: 1px solid #eee;">
                    <ul class="px-4 mt-5 border-0 nav nav-tabs flex-column" id="myTabs" role="tablist">
                        <li class="mb-2 nav-item" role="presentation">
                            <button class="py-4 w-100 rounded-0 nav-link bg-light text-dark text-start active"
                        ...
                        <li class="mb-2 nav-item" role="presentation">
                            <button class="py-4 w-100 rounded-0 nav-link text-start bg-light text-dark" id="tab2-tab"
                        ...
                        <li class="mb-2 nav-item" role="presentation">
                            <button class="py-4 w-100 rounded-0 nav-link text-start bg-light text-dark" id="tab3-tab"
                            ...
                            <div class="p-4 bg-white tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="tab1" role="tabpanel"
                                    ...
                                    <div class="row g-3 align-items-center"> <!-- use g-3 for spacing between inputs -->
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            ...
                                            <textarea class="form-control form-control-sm form-control-solid" name="name" id="product_name" rows="1"
                                                placeholder="Product Name" required style="font-size: 12px; font-weight: 600;"></textarea>
                                        </div>

                                        {{-- SKU Code --}}
                                        <div class="col-lg-2 col-md-3">
                                            <label for="sku_code" class="form-label">SKU Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="sku_code" id="sku_code"
                                                class="form-control form-control-sm form-control-solid" placeholder="Enter SKU Code"
                                        ...
                                        <div class="col-lg-2 col-md-3">
                                            ...
                                            <input type="text" name="mf_code" id="mf_code"
                                                class="form-control form-control-sm form-control-solid" placeholder="Manufacturing Code"
                                        ...
                                        <div class="col-lg-9 col-md-8">
                                            ...
                                            <input type="text" name="tags" class="form-control form-control-sm form-control-solid"
                                                data-role="tagsinput" placeholder="Product Tags">
                                        </div>
                                        <div class="col-lg-3 col-md-4">
                                            <label for="product_type" class="form-label">Product Type <span
                                                    class="text-danger">*</span></label>
                                            <select name="product_type" id="product_type" data-control="select2"
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            ...
                                            <input type="text" name="product_code" id="product_code"
                                                class="form-control form-control-sm form-control-solid" placeholder="Product Code">
                                        </div>
                                        {{-- Stock --}}
                                        <div class="col-lg-3 col-md-6">
                                            <label for="stock" class="form-label">Stock <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select form-select-sm form-select-solid stock_select"
                                                data-control="select2" data-allow-clear="true"
                                                data-placeholder="Select an option" name="stock" required>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            ...
                                            <select name="brand_id" class="form-select form-select-sm form-select-solid"
                                                data-control="select2" data-allow-clear="true"
                                        ...
                                        <div class="col-lg-2 col-md-6">
                                            <label for="notification_days" class="form-label">Notification Day <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="notification_days"
                                                class="form-control form-control-sm form-control-solid" placeholder="Notification Day"
                                                required>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <label for="solution_id" class="form-label">Solution <span
                                                    class="text-danger">*</span></label>
                                            <select name="solution_id[]" data-control="select2"
                                                data-allow-clear="true" data-placeholder="Select an option"
                                                class="form-select form-select-sm form-select-solid" multiple required>
                                                <option></option>
                                        ...
                                        {{-- Industries --}}
                                        <div class="col-lg-6 col-md-6">
                                            <label for="industry_id" class="form-label">Industry <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <label for="cat_id" class="form-label">Category <span
                                                    class="text-danger">*</span></label>
                                            <select name="cat_id" data-control="select2" data-allow-clear="true"
                                                data-placeholder="Select an option" class="form-select form-select-sm form-select-solid"
                                                required>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            ...
                                            <select name="sub_cat_id" data-control="select2" data-allow-clear="true"
                                                data-placeholder="Select an option"
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            ...
                                            <select name="sub_sub_cat_id" data-control="select2"
                                                data-allow-clear="true" data-placeholder="Select an option"
                                                class="form-select form-select-sm form-select-solid">
                                                <option value="" disabled selected>Select Sub Sub Category
                                                </option>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <label for="sub_sub_sub_cat_id" class="form-label">Sub Sub Sub
                                                Category</label>
                                            <select name="sub_sub_sub_cat_id" data-control="select2"
                                                data-allow-clear="true" data-placeholder="Select an option"
                                                class="form-select form-select-sm form-select-solid">
                                                <option value="" disabled selected>Select Sub Sub Sub Category
                                                </option>
                                        ...
                                        <div class="col-lg-2 col-md-6">
                                            ...
                                            <input type="text" name="size" class="form-control form-control-sm form-control-solid"
                                        ...
                                        <div class="col-lg-2 col-md-6">
                                            ...
                                            <input type="text" name="color" class="form-control form-control-sm form-control-solid"
                                                data-role="tagsinput" placeholder="Product Colors">
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 qty_display d-none">
                                            ...
                                            <input type="text" name="qty" id="qty"
                                                class="form-control form-control-sm form-control-solid qty_required" placeholder="Quantity(10,50,100)">
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="refurbished"
                                                    id="refurbished" value="1">
                                                <label class="form-check-label" for="refurbished">Refurbished</label>
                                            </div>
                                            <div class="pt-5 form-check">
                                                <input class="border form-check-input" type="checkbox"
                                                    id="dealId">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <textarea class="form-control form-control-sm form-control-solid" name="warranty" rows="1" placeholder="Product Warranty"
                                                style="font-size: 12px; font-weight: 500;"></textarea>
                                        </div>

                                        <div class="col-lg-12 col-md-6" id="dealExpand" style="display:none">
                                            <label class="mt-3 form-label">Deals Info <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="deal" class="form-control form-control-sm form-control-solid"
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <x-metronic.label for="thumbnail" class="fw-bold fs-6 required">Main Thumbnail</x-metronic.label>
                                            <x-metronic.file-input :class="'form-control-sm form-control-solid'" id="thumbnail" name="thumbnail"
                                                :value="old('thumbnail')"></x-metronic.file-input>
                                        </div>
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <input type="file" class="form-control form-control-solid form-control-sm"
                                                name="multi_img[]" id="multiImg" multiple>
                                        ...
                                        <div class="col-12 text-end">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-info"
                                                id="nextTabButton">Next <i class="fas fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="px-0 mb-1 row gx-1">
                                            <div class="col-lg-12">
                                                <div class="mb-2 form-group">
                                                    ...
                                                    <textarea name="short_desc" class="form-control form-control-solid ckeditor_classic"
                                                        placeholder="Product Short Description" id="short_desc" rows="4"
                                                        style=" font-size: 12px; font-weight: 500;"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="mb-2">
                                                    ...
                                                    <textarea class="form-control form-control-solid ckeditor_classic" placeholder="Product Overview" name="overview"
                                                        id="overview" rows="4" style=" font-size: 12px; font-weight: 500;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="px-0 row gx-1">
                                            <div class="col-lg-12 col-sm-12">
                                                <div class="mb-2">
                                                    ...
                                                    <textarea class="form-control form-control-solid ckeditor_classic" placeholder="Product Specification"
                                                        name="specification" id="specification" rows="4" style=" font-size: 12px; font-weight: 500;"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-sm-12">
                                                <div class="mb-2">
                                                    <label for="warranty" class="form-label">Accessories</label>
                                                    <textarea class="form-control form-control-solid ckeditor_classic" placeholder="Product Accessories"
                                                        name="accessories" id="accessories" rows="4" style=" font-size: 12px; font-weight: 500;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="tab3" role="tabpanel"
                                    ...
                                    <div class="px-2 mb-5 row gx-5">
                                        <div class="col-lg-6 col-sm-6">
                                            ...
                                            <select name="price_status" id="price_status"
                                                class="form-select form-select-solid price_select" required
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select name="source_type" data-placeholder="Select Source Type.."
                                                ...
                                                data-allow-clear="true">
                                                <option></option>
                                                <option class="form-control form-control-solid" value="principal">
                                                    Principal</option>
                                                <option class="form-control form-control-solid" value="distributor">
                                                    Distributor</option>
                                                ...
                                                <table class="table mb-0 table-hover table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input
                                                                    class="form-control form-control-sm form-control-solid allow_decimal"
                                                            ...
                                                            <td>
                                                                <input
                                                                    class="form-control form-control-sm form-control-solid allow_decimal"
                                                                    type="text" name="source_one_principal_time"
                                                                    id="">
                                                            </td>
                                                            <td>
                                                                <input
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input class="form-control form-control-sm form-control-solid"
                                                            ...
                                                            <td><input
                                                                    class="form-control form-control-sm form-control-solid allow_decimal"
                                                                    type="text" name=" source_two_estimate_time"
                                                                    id=""></td>
                                                            <td><input
                                                                    class="form-control form-control-sm form-control-solid allow_decimal"
                                                                    type="text" name="source_two_principal_time"
                                                                    id=""></td>
                                                            <td><input
                                                                    class="form-control form-control-sm form-control-solid allow_decimal"
                                                ...
                                                <table class="table mb-0 table-hover table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="pe-3"><input class="margin-right:0.5rem"
                                                                    type="radio" name="solid_source" value="no"
                                                                    id="">&nbsp; No
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pe-3"><input class="margin-right:0.5rem"
                                                                    type="radio" name="agreement" value="no"
                                                                    id="">&nbsp; No</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                    ...
                                    <div class="px-2 mb-3 row gx-5 text-end">
                                        ...
                                        <div class="col-lg-8">
                                            <button type="submit" class="btn btn-success save_btn" id="submitbtn"
                                                name="action" value="save">Save<i
                                                    class="mx-2 fas fa-download"></i></button>

                                            <button type="submit" class="btn btn-primary" name="action"
                                                id="submitbtn" value="approval">Send For
                                                SAS<i class="mx-2 fas fa-plane-departure"></i></button>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const tagifyInputs = document.querySelectorAll("");
