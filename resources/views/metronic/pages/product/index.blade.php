<x-admin-app-layout :title="'Sourced Products (Pending for Approval)'">
    {{-- ===== Top Info Cards ===== --}}
    <div class="mb-5 row gx-4">
        ...
        'count' => $products->where('action_status', 'listed')->count(),
        ...
        'count' => $products->where('action_status', 'rejected')->count(),
