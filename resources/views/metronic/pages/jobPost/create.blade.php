<x-admin-app-layout :title="'Job Post Add'">
            ...
            <form class="form" action="{{ route('admin.job-post.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.input id="link" type="text" name="link" :value="old('link')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="category" type="text" name="category" :value="old('category')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="experience" type="text" name="experience" :value="old('experience')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="vacancy" type="text" name="vacancy" :value="old('vacancy')"
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="deadline" type="date" name="deadline" :value="old('deadline')"
