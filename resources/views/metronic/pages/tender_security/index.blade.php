                ...
                <div class="p-10 shadow-sm card rounded-4 d-flex align-items-center"
                    ...
                    <div class="d-flex align-items-center justify-content-between w-100">
                        <div>
                            ...
                            <span class="text-black"><i class="bi bi-hourglass-split"></i> Awaiting Return</span>
                        </div>
                ...
                <div class="p-10 shadow-sm card rounded-4 d-flex align-items-center"
                    ...
                    <div class="d-flex align-items-center justify-content-between w-100">
                        <div>
                            ...
                            <span class="text-black"><i class="bi bi-check-circle"></i> Security Returned</span>
                        </div>
        ...
        <div class="card rounded-4">
            <div class="p-5 text-white border card-header d-flex justify-content-between align-items-center"
                ...
                <div class="d-flex align-items-center">
                    {{-- Filter Form --}}
                    <form action="{{ route('admin.tender-security.index') }}" method="GET" class="d-flex align-items-center">
                        <select class="py-3 w-150px form-select form-select-sm form-select-solid" data-control="select2"
                                data-placeholder="Filter Status" data-allow-clear="true" name="status" onchange="this.form.submit()">
                            <option></option>
                            <option value="Pending" {{ request('status') == 'Pending' ? 'selected' : '' }}>Pending</option>
                            <option value="Returned" {{ request('status') == 'Returned' ? 'selected' : '' }}>Returned</option>
                        </select>
                        @if(request('status'))
                            <a href="{{ route('admin.tender-security.index') }}" class="btn btn-sm btn-white ms-2 bg-white text-danger"><i class="bi bi-x-lg"></i></a>
                        @endif
                    </form>
                    
                    <button class="py-4 btn btn-primary btn-sm ms-3 w-100" data-bs-toggle="modal" data-bs-target="#createModal">
                                ...
                                <tr class="border-b">
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="fw-bold text-gray-800">{{ $security->reference_no ?? '-' }}</span>
                                            <span class="text-muted small">{{ Str::limit($security->tender_description, 20) }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="fw-bold">{{ $security->tenderer_name }}</span>
                                            <span class="text-muted small">{{ Str::limit($security->bank_name, 20) }}</span>
                                        </div>
                                    </td>
                                    <td>{{ number_format($security->amount, 2) }}</td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="badge badge-light-primary">{{ $security->security_type }}</span>
                                            <span class="text-muted small mt-1">{{ $security->pay_order_number }}</span>
                                        </div>
                                    </td>
                                    <td>{{ $security->issue_date ? $security->issue_date->format('d M, Y') : '-' }}</td>
                                    <td>
                                    ...
                                    <td class="text-end pe-4">
                                        <button type="button" class="px-3 me-4 btn btn-sm btn-light text-success edit-btn"
                                            data-id="{{ $security->id }}"
                                        ...
                                        <a class="delete px-3 btn btn-sm btn-light" href="{{ route('admin.tender-security.destroy', $security->id) }}">
                ...
                <div class="shadow modal-content rounded-4">
                    ...
                    <form action="{{ route('admin.tender-security.store') }}" method="POST">
                        ...
                        <div class="p-4 modal-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Tenderer Name <span class="text-danger">*</span></label>
                                    <input type="text" name="tenderer_name" class="form-control" placeholder="Company Name" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Tender Ref / eGP ID</label>
                                    <input type="text" name="reference_no" class="form-control" placeholder="e.g. eGP Id: 876323">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Bank Name</label>
                                    <input type="text" name="bank_name" class="form-control" placeholder="e.g. Pubali Bank Ltd.">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Security Type</label>
                                    <select name="security_type" class="form-select" data-control="select2" data-dropdown-parent="#createModal">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="pay_order_number" class="form-control" placeholder="PO Number">
                                </div>
                                <div class="col-md-6">
                    ...
                    <form id="editForm" method="POST">
                        ...
                        <div class="p-4 modal-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Tenderer Name <span class="text-danger">*</span></label>
                                    <input type="text" name="tenderer_name" id="edit_tenderer_name" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Tender Ref / eGP ID</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Security Type</label>
                                    <select name="security_type" id="edit_security_type" class="form-select" data-control="select2" data-dropdown-parent="#editModal">
                                        <option value="">Select Type</option>
                                        <option value="Tender Security">Tender Security</option>
                                        <option value="Tender Security (eGP)">Tender Security (eGP)</option>
                                        <option value="Performance Security">Performance Security</option>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Pay Order Number</label>
                                    <input type="text" name="pay_order_number" id="edit_pay_order_number" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Amount <span class="text-danger">*</span></label>
