    ...
    <div class="px-0 container-fluid">
        <div class="row five-col-grid">
            ...
            @foreach ($cards as $card)
                <div class="col-6 col-sm-6 col-md-4 col-xl custom-col mb-4">
        ...
        <div class="mt-10 row">
            <div class="col-lg-12">
                <div class="shadow-none card card-flush card-rounded">
                    <div class="pt-4 border-0 card-header align-items-center px-3 px-lg-9">
                        ...
                        <ul class="nav nav-pills nav-pills-custom mx-3 mx-lg-9" role="tablist">
                            @foreach ($tabs as $index => $tab)
                                <li class="nav-item me-3 me-lg-6 mb-3 mb-lg-0" role="presentation">
