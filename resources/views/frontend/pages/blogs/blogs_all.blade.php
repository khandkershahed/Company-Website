...
<div>
    ...
    <section class="pt-5">
        <div class="container">
            ...
            <div class="row">
                ...
                {{-- <div class="order-1 mb-4 col-md-3 order-md-2 mb-lg-0">
                        <div>
                            <h4>Search</h4>
                            <form action="">
                        ...
                        <div class="p-5 pt-4 mt-4 text-center border">
                            <h5 class="">e-news</h5>
                            <p class="pt-3">
                        ...
                        <div>
                            <h5 class="mt-5 text-center title-border-bottom mt mb0 fw-bold">
                                Releted Blog
                            </h5>
                        </div>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="mt-5 mb-5 col-lg-12 mt-lg-0">
                ...
                <div class="mb-4 col-lg-6">
                    <div>
                        <h5 class="text-center title-border-bottom mt mb0 fw-bold">
                            Client Stories
                        </h5>
                    </div>
                    <div class="mb-4 row">
                            ...
                            <div class="card recent-blogs">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title date">
                                        {{ $story->created_at ? $story->created_at->format('F d, Y') : '' }}
                                    </h5>
                                    <h5 class="card-title recent-items">
                                        <a href="{{ route('story.details', $story->slug) }}" class="text-dark">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="mb-3 col-lg-6">
                            <div class="card recent-blogs">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title date">
                                        {{ $tech->created_at ? $tech->created_at->format('F d, Y') : '' }}
                                    </h5>
                                    <h5 class="card-title recent-items">
