                ...
                <div class="col-lg-10">
                    <div class="border-0 shadow-sm card">
                        ...
                        <div class="p-4 card-body">
                            <form id="stepperForm" action="{{ route('rfqCreate') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div data-repeater-list="contacts">
                                            <div data-repeater-item class="row g-1">
                                                <div class="col-lg-1 col-2">
                                                    <input type="text" name="sl" class="text-center form-control"
                                                        value="1" />
                                                </div>
                                                ...
                                                <div class="col-lg-1 col-2">
                                                    <div class="d-flex">
                                                        <input type="text" id="qty" value="1"
                                                            class="text-center form-control" min="1" readonly
                                                ...
                                                <div class="col-lg-1 col-2">
                                                    <button type="button" data-repeater-delete
                                                        class="py-2 btn btn-danger btn-sm w-100 trash-btn delete-btn" onclick="deleteRow(this)">
                                                        <i class="fas fa-trash"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" data-repeater-create class="mt-4 mb-3 rfq-add-btns" onclick="addRow()">
                                                    ...
                                                    <div id="checkDefaultContainer">
                                                        <div class="mb-4 form-check">
                                                            <input class="form-check-input custom-form-check"
                                                                type="checkbox" value="" id="endUser" disabled
                                                                required />
