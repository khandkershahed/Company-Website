                                    ...
                                    <div class="repeater">
                                        <div data-repeater-list="contacts">
                                            @if ($cart_products->count() > 0)
                                                @foreach ($cart_products as $key => $cart_product)
                                                    @php
                                                        $modalId = 'modal-' . $key;
                                                        $product = App\Models\Product::where('name', $cart_product->name)->select('sku_code','brand_id')->first();
                                                    @endphp
                                                    <div data-repeater-item class="row g-1">
                                                        <div class="col-lg-1 col-12">
                                                            <button type="button"
                                                                title="Provide Additional Product Information"
                                                                class="px-10 border-0 shadow-sm deal-modal-btn btn btn-light btn-sm w-75"
                                                                style="font-size: 30px;" data-bs-toggle="modal"
                                                        ...
                                                        <div class="col-lg-8 col-6">
                                                            <input type="text" name="product_name"
                                                                class="form-control" value="{{ $cart_product->name }}"
                                                        ...
                                                        <div class="col-lg-1 col-2">
                                                            <div class="d-flex">
                                                                <button type="button" data-repeater-delete
                                                                    ...
                                                                    data-id="{{ $cart_product->rowId ?? 'new' }}">
                                            ...
                                            @else
                                                <div data-repeater-item class="row g-1">
                                                    ...
                                                    <div class="col-lg-1 col-12">
                                                        <button type="button"
                                                            class="py-4 mb-3 border-0 shadow-sm btn btn-light btn-sm cst-btn mb-lg-0"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-xl">
                                                                <div class="border-0 modal-content rounded-0">
                                                                    <div class="py-2 modal-header bg-light">
                                                                        <h1 class="modal-title fs-5"
                                                                            id="{{ $modalId }}Label">Product Details
                                                                        </h1>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="Close"></button>
                                                                        ...
                                                                        <div class="row gx-2">
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="mb-3">
                                                                                    <label
                                                                                        class="form-label fw-normal">Upload
                                                                                        Product Datasheet / Images</label>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <button type="button" class="bg-transparent border-0 modal-text-btn"
                                                ...
                                                <div class="modal fade" id="rfqModal" tabindex="-1"
                                                    aria-labelledby="rfqModalLabel" aria-hidden="true">
