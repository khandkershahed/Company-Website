                        ...
                        <form action="{{ route('rfqCreate') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div id="projectStep" class="p-3">
                                <div class="row gx-2">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div id="toggle-content" style="display: none;" class="mb-4">
                                            <div class="row gx-2">
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <select class="select-form-input w-100 cst-select form-select"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="my-4">
                                            <p class="mb-0">End User Info</p>
                                            <div class="checkbox-wrapper-4 ps-0">
                                                <input class="inp-cbx" id="enduser" type="checkbox" checked
                                                    onchange="toggleEndUserDiv()" />
                                                <label class="cbx ps-0" for="enduser">
                                                    <span>
                                                        <svg width="12px" height="10px">
                                                            <use xlink:href="#enduser-location"></use>
                                                        </svg>
                                                    </span>
                                                    <span class="ps-2" style="font-weight: normal;">Same As Delivery
                                                        Location</span>
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <svg class="inline-svg">
                                                    <symbol id="enduser-location" viewBox="0 0 12 10">
                                                        <polyline points="1.5 6 4.5 9 10.5 1"></polyline>
                                                    </symbol>
                                                </svg>
                                            </div>
                                        </div>
                                        <div id="toggle-content-enduser" style="display: none;" class="mb-4">
                                            <div class="row gx-2">
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <select class="select-form-input w-100 cst-select form-select"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        <input name="designation" type="number"
                                                            class="py-3 border-0 form-control form-control-sm rounded-1"
                                                            placeholder="Phone..">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        <input name="designation" type="email"
                                                            class="py-3 border-0 form-control form-control-sm rounded-1"
                                                            placeholder="Email..">
                                                    </div>
                                                </div>
