                        ...
                        <div class="row">
                            <div class="col-lg-12 col-12">
                                <ul class="nav nav-tabs justify-content-between" id="myTab" role="tablist">
                                    ...
                                    <li class="border-0 nav-item rounded-0" role="presentation">
                            ...
                            <div class="tab-pane fade show active" id="safty" role="tabpanel"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mt-4">
                                            <a href="#" class="px-4 btn btn-outline-primary rounded-0 Content-watch"
                ...
                <div>
                    <div class="d-flex justify-content-center">
                        <a href="{{ $solution->row_two_column_one_link ?? 'javascript:void(0)' }}">
                            <img class="rounded-3 card-img-top"
                                ...
                                alt="Card image cap" style="width: 420px; height: 420px;">
                        </a>
                    </div>
...
<section>
    <div class="py-5 container-fluid" id="section1">
        <div class="container">
            <div class="row gx-0">
                <div class="col-lg-12">
                    <h3 class="py-4 category-titles">
...
<section class="py-5 bg-colors-ind" id="solutions">
    <div class="container py-5 pt-0 pb-0 pb-lg-5">
        <h2 class="pb-5 text-center text-white fw-bold">{{ $solution->row_four_title }}</h2>
        <div class="row">
            <div class="px-0 col-lg-12">
                <div class="row">
                    <div class="px-0 col-lg-12 col-12" style="border-bottom: 1px solid white">
                        <ul class="px-0 nav nav-tabs justify-content-between" id="myTab" role="tablist"
                            style="margin-bottom: -4.1px;">
                            <!-- First Set of Tabs -->
                            @if (!empty($solution->row_five_badge))
                            <li class="mx-0 nav-item" role="presentation">
                                <button class="text-white nav-link active growth-tabs-triger" id="first-tab-1"
                            ...
                            <li class="mx-0 border-0 nav-item rounded-0" role="presentation">
                                <button class="text-white nav-link growth-tabs-triger" id="first-tab-2"
                            ...
                            <li class="mx-0 border-0 nav-item rounded-0" role="presentation">
                                <button class="text-white nav-link growth-tabs-triger" id="first-tab-3"
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <img class="img-fluid rounded-3"
                                        ...
                                        alt="" style="width: 635px; height: 455px;"/>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <h3 class="pt-4 pb-3 text-white pt-lg-0 tab_title">
                                    {{ $solution->row_five_badge }}
                                </h3>
                                ...
                                <div class="mt-4">
                                    <a href="{{ $solution->row_five_link }}" class="px-4 btn btn-outline-light rounded-0 Content-watch"
                    ...
                    <div class="tab-pane fade" id="first-content-2" role="tabpanel"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mt-4">
                                    <a href="{{ $solution->row_six_link }}" class="px-4 btn btn-outline-light rounded-0 Content-watch"
                    ...
                    <div class="tab-pane fade" id="first-content-3" role="tabpanel"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mt-4">
                                    <a href="{{ $solution->row_seven_link }}" class="px-4 btn btn-outline-light rounded-0 Content-watch"
...
<section class="py-5" id="feature">
    <h2 class="pb-5 text-center fw-bold">Featured Products</h2>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="product-card">
                            ...
                            <div class="overlay-st-one">
                                <div class="overlay-st-one-text">
                                    <p class="pt-2 overlay-st-one-para">
...
@if ($features->count() > 0)
<section class="py-5 bg-colors-ind">
    <div class="container">
        <div class="row">
            <div class="py-5 pt-0">
            ...
            <div class="col-lg-3 col-12">
                <div class="mt-4 border-0 card rounded-0"
