                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div>
                            ...
                            <div>
                                <h5>Sustainability & Work Safety</h5>
                                <ul class="">
                                    <li>Improve energy efficiency</li>
                                    <li>Energy base line & performance indicator monitoring</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-10">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div>
                                        <div>
                                            <img class="img-fluid catory-banner-img" src="https://advcloudfiles.advantech.com/cms/97db910f-c942-4864-be43-96ec19cf9e95/Resources%20Case%20Study%20Featured%20Image%20for%20Detail%20Page/200552361-001cms.jpg"
                                                alt="" />
                                        </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-12">
                      ...
                      >
                        <li class="nav-item" role="presentation">
                          <button
                            class="nav-link active growth-tabs-triger"
                            id="helth&Safety"
                            data-bs-toggle="tab"
                            data-bs-target="#safty"
                            type="button"
                            role="tab"
                            aria-controls="safty"
                            aria-selected="true"
                        ...
                        <li class="nav-item border-0 rounded-0" role="presentation">
                          <button
                            class="nav-link growth-tabs-triger"
                            id="automation-tab"
                            data-bs-toggle="tab"
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-12" style="border-bottom: 1px solid white">
                      ...
                      >
                        ...
                        <li class="nav-item" role="presentation">
                          <button
                            class="nav-link active growth-tabs-triger text-white"
                            id="first-tab-1"
                            data-bs-toggle="tab"
                            data-bs-target="#first-content-1"
                            type="button"
                            role="tab"
                            aria-controls="first-content-1"
                            aria-selected="true"
                          >
                            Environment, Health & Safety
                          </button>
                        ...
                        <li class="nav-item border-0 rounded-0" role="presentation">
                          <button
                            class="nav-link growth-tabs-triger text-white"
                            id="first-tab-2"
                            data-bs-toggle="tab"
                            data-bs-target="#first-content-2"
                            type="button"
                            role="tab"
                            aria-controls="first-content-2"
                            aria-selected="false"
                          >
                            Equipment Automation Management
                          </button>
                        ...
                        <li class="nav-item border-0 rounded-0" role="presentation">
                          <button
                            ...
                            id="first-tab-3"
                            data-bs-toggle="tab"
                            data-bs-target="#first-content-3"
                            type="button"
                            role="tab"
                            aria-controls="first-content-3"
                            aria-selected="false"
                          >
                            Total Productive Maintenance
                          </button>
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="mt-4">
                            <a
                              href="#"
                              class="btn btn-outline-light rounded-0 Content-watch px-4"
                              style="text-decoration: none"
                              tabindex="0"
                              >Become A Partner</a
                            >
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-lg-3 col-12">
                  <div
                    class="card border-0 rounded-0 mt-4"
                    style="background-color: rgba(255, 255, 255, 0.35)"
                  >
                    <div>
                      <img
                        src="https://advcloudfiles.advantech.com/web/Images/Solutions/iFactory/202212version/links/1-IEM-white-820x460px.png"
                    ...
                    <div class="p-3 text-center">
                      <h5 class="fw-bold text-white">Equipment Manufacturing</h5>
                      <p class="text-white">
                        Smart AIoT Solution for Equipment Builder
                      </p>
                    </div>
                  </div>
                </div>
