...
<head>
    ...
    <style>
        ...
        .page-wrapper {
            ...
            padding-bottom: 85px; /* Footer height + some spacing */
        }
        ...
        /* To ensure footer doesn't overlap content */
        .main-content {
            min-height: calc(297mm - 150px); /* A4 height minus header and footer space */
            overflow: hidden;
        }
...
<body style="margin:0; padding:0; width:100%; font-family: 'Montserrat', sans-serif; font-size: 12px;">
    ...
    <div class="page-wrapper">
                                ...
                                @if ($products->count() > 0)
                                    @foreach ($products as $quotationproduct)
                                        @if($loop->iteration > 15)
                                            <!-- Page break after 15 products -->
                                            <tr>
                                                <td colspan="5" style="page-break-before: always; height: 0;">
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="5"
                            ...
                            <tbody>
                                @foreach ($rfq_terms as $term)
                                    @if($loop->iteration > 8)
                                        <!-- Page break after 8 terms -->
                                        <tr>
                                            <td colspan="3" style="page-break-before: always; height: 0;">
                                                <div class="page-break"></div>
                                            </td>
                                        </tr>
                                    @endif
        ...
        <!-- Fixed Footer - Always at bottom of each page -->
