    ...
    <div class="pdf-container">
        ...
        <div class="header">
            <div class="header-content">
                ...
                <div>
                    <h1 style="margin: 0; font-size: 24px; position: relative; left: -65px;">
                        Price Quotation
                    </h1>
                </div>
            </div>
        ...
        <div class="pb-0 content">
                ...
                <thead>
                    ...
                    <tr>
                        <th style="border: 0; padding: 0; padding-top: 5px; font-weight: normal;">
                            {{ $quotation->name ?? 'N/A'}}| {{ $quotation->sender_designation ?? 'Sr. Manager' }}
                        </th>
            ...
            <table class="content-table table-two" style="margin-top: 5px; border: 0px solid #eee">
                <tbody>
                    ...
                    <tr>
                        <td style="font-size: 12px; padding: 5px; border: 0; font-weight: 500;">{{ $term->title ?? 'N/A'}}</td>
                        <td style="font-size: 12px; padding: 5px; border: 0; font-weight: 500;">:</td>
                        <td style="font-size: 12px; padding: 5px; border: 0;">{{ $term->description ?? 'N/A'}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <table class="content-table table-two" style="margin-top: 15px">
                <tbody>
                    <tr>
                        <td colspan="6" style="padding: 0; border: 0; text-align: end; font-weight: 500; padding-bottom: 8px;">
                            Authorized Brands
                        </td>
                    </tr>
                </tbody>
                <tbody style="background-color: #f0f0f0">
                    <tr style="padding: 10px">
                        <td class="table-two-th" style="padding: 0">
                            <img src="https://download.logo.wine/logo/Acronis/Acronis-Logo.wine.png" alt="Acronis Logo" style="padding-left: 15px; width: 100px" />
                        </td>
                        <td class="table-two-th" style="padding: 0">
                            <img src="https://download.logo.wine/logo/Acronis/Acronis-Logo.wine.png" alt="Acronis Logo" style="padding-left: 15px; width: 100px" />
                        </td>
