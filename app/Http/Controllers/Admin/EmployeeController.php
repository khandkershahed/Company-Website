...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        User::create([
            ...
            'last_evaluation_date'                          => $request->last_evaluation_date,
    ...
    public function update(Request $request, $id)
    {
        ...
        //     'supervisor_id'                                 => $request->supervisor_id ?? $admin->supervisor_id,
        ...
        //     'designation'                                   => $request->designation ?? $admin->designation,
        //     'address'                                       => $request->address ?? $admin->address,
        //     'city'                                          => $request->city ?? $admin->city,
        //     'country'                                       => $request->country ?? $admin->country,
        //     'postal'                                        => $request->postal ?? $admin->postal,
        //     'last_seen'                                     => $request->last_seen ?? $admin->last_seen,
        //     'role'                                          => $request->role ?? $admin->role ?? $request->role ?? $admin->role,
        //     'department'                                    => json_encode($request->department) ?? $admin->department,
        //     'status'                                        => 'active',
        ...
        // Start building update array with optional file uploads and password
        $updateData = [
            'photo' => $uploadedFiles['photo']['status'] == 1 ? $uploadedFiles['photo']['file_path'] : $admin->photo,
            'sign' => $uploadedFiles['sign']['status'] == 1 ? $uploadedFiles['sign']['file_path'] : $admin->sign,
            'ceo_sign' => $uploadedFiles['ceo_sign']['status'] == 1 ? $uploadedFiles['ceo_sign']['file_path'] : $admin->ceo_sign,
